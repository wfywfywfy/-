            ...
            >
              <template slot-scope="{row,$index}">
                <el-button
                  ...
                  @click="goDetail(row)"
                >
                  <i class="el-icon-edit-outline" /> 管理
                </el-button>
...
<script>
import { villageinfoList } from '@/api/rural-revitalization/rural-revitalization'
...
export default {
  ...
  methods: {
    ...
    goDetail() {
      this.$router.push({
        path: '/rural-revitalization/rural-information-detail',
        query: {
          cityId: this.cityId
        }
      })
    ...
    getList() {
      ...
      villageinfoList(params).then((res) => {
